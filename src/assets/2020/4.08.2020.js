...
const dayNote = {
  [keys._date.name]: "4.08.2020",
  [keys._tags.name]: [tags.LINKED_IN, tags.CSS],
  [keys._keywords.name]: ["CSS animation"],
  [keys._workEvents.name]: [],
  [keys._bulletsList.name]: ["Recruiter from GFT is interested in my application.", "I have send CV to Krzysztof Bergiela from Sitecore", ""],
